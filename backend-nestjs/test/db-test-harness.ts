 ...
 *
 * الحاوية بتقوم مرة واحدة لكل عملية اختبار، والجداول بتتفضّى بين
 * الاختبارات. الاختبارات دي بتشتغل بـ npm run test:integration بس،
 * مش مع npm test العادي (شوف testPathIgnorePatterns في package.json).
 */
